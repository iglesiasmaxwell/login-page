...
<body>
    <div class="login-box middle" id="loginBox">
        <div class="title-box">
            <p>SIGN<span class="title-span">UP</span></p>
        </div>
        <!-- <p>
    ...
    <div class="input-box">
        <form action="" method="POST">
            ...
            <div>
                <a class="chk-un" href="checkun.php">Check Username?</a>
            </div>
            <div class="button-box center">
                <button class="login-button" type="submit" name="signup"> <?= $warn; ?> </button>
            </div>
        </form>
    </div>
    ...
    <div class="signup-con">
        <p>Already have an account?<a href="../index.php" class="signup-a">Log In</a></p>
    </div>
    </div>
