...
<body>
    <div class="login-box middle" id="loginBox">
        <div class="title-box">
            <p>LOG<span class="title-span">IN</span></p>
        </div>
        <!-- <p>
    ...
    <div class="input-box">
        <form action="" method="POST">
            ...
            <div class="pw-con">
            <input class="input" type="password" placeholder="Password" name="pword" id="pwInput">
                <i class="fa fa-eye icon" onclick="showPass()" id="eyeCon"></i>
            </div>
            <div>
                <a class="pw-fgt" href="view/updatepw.php">Forgot Password?</a>
            </div>
            <div class="button-box center">
                <button class="login-button" type="submit" name="login"> <?= $warn; ?> </button>
            </div>
        </form>
    </div>
    ...
    <div class="signup-con">
        <p>Don't have an account?<a href="view/signup.php" class="signup-a">Sign Up</a></p>
    </div>
    </div>
